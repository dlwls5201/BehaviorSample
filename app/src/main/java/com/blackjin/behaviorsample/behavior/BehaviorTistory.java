...
public class BehaviorTistory extends CoordinatorLayout.Behavior<TextView> {
    ...
    public boolean onDependentViewChanged(@NonNull CoordinatorLayout parent,
        ...
        child.setX(getRatioValue(marginLeft, (dependency.getWidth() - child.getWidth()) / 2,
                Math.abs(dependency.getY()), getYMax));
